        ...
        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap:40px; margin-bottom:60px;">
            ...
            <div>
                ...
                <div class="social-links">
                    <a href="https://www.linkedin.com/in/somnath-kurmi-027128385" target="_blank" class="social-icon" aria-label="LinkedIn">
                    ...
                    <a href="https://x.com/drn_today" target="_blank" class="social-icon" aria-label="X (Twitter)">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M18.244 2H21.5l-7.19 8.21L22.5 22h-6.48l-5.08-6.64L4.7 22H1.44l7.7-8.8L1.5 2h6.64l4.58 6.05L18.24 2zm-1.14 18h1.8L7.04 4h-1.9l11.96 16z"/>
                        </svg>
                    </a>
                    <a href="https://www.facebook.com/profile.php?id=61583320771934" target="_blank" class="social-icon" aria-label="Facebook">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/drn_today" target="_blank" class="social-icon" aria-label="Instagram">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="https://github.com/drntoday" target="_blank" class="social-icon" aria-label="GitHub">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
